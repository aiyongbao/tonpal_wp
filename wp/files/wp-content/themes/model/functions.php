...
// Start the UL
        echo '<ul class="list-inline custom-breadcrumb">';
// Add the Home link
        echo '<li class="list-inline-item"><a class="h2 text-primary font-secondary" href="'. get_option('home') .'">Home</a></li>';
        ...
        {
            echo "<li class='list-inline-item text-white h3 font-secondary nasted'>Archives</li>";
        }
        elseif ( is_search() ) {

            echo "<li class='list-inline-item text-white h3 font-secondary nasted'>Search Results</li>";
        }
        elseif ( is_404() )
        {
            echo "<li class='list-inline-item text-white h3 font-secondary nasted'>404 Not Found</li>";
        }
        elseif ( is_single() )
        {

...
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="logo">
                        <a href="index.html">
                            <img src="<?php echo get_template_directory_uri()?>/assets/images/resources/logo.png" alt="Awesome Logo">
                        </a>
                    </div>
                </div>
        ...
        <div id="slider1" class="rev_slider"  data-version="5.0">
            <ul>
                ...
                <li data-transition="fade">
                    <img src="<?php echo get_template_directory_uri()?>/assets/images/slides/1.jpg"  alt="" width="1920" height="540" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
                ...
                <li data-transition="fade">
                    <img src="<?php echo get_template_directory_uri()?>/assets/images/slides/2.jpg" alt="" width="1920" height="540" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
                ...
                <li data-transition="fade">
                    <img src="<?php echo get_template_directory_uri()?>/assets/images/slides/3.jpg" alt="" width="1920" height="540" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-item text-center">
                        ...
                        <div class="img-holder">
                            <img src="<?php echo get_template_directory_uri()?>/assets/images/callto-action/1.jpg" alt="Awesome Image">
                            <div class="overlay">
                                <div class="box">
                                    <div class="content">
                ...
                <div class="col-md-4">
                    <div class="single-item text-center">
                        ...
                        <div class="img-holder">
                            <img src="<?php echo get_template_directory_uri()?>/assets/images/callto-action/2.jpg" alt="Awesome Image">
                            <div class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
    ...
    <section class="categories-area" style="background-image:url(<?php echo get_template_directory_uri()?>/assets/images/resources/categories-bg.jpg);">
        <div class="container">
                ...
                <div class="col-md-6">
                    <div class="about-content">
                        ...
                        <ul>
                            <li>
                                <div class="img-holder">
                                    <img src="<?php echo get_template_directory_uri()?>/assets/images/about/1.jpg" alt="Awesome Image">
                                </div>
                            </li>
                            <li>
                                <div class="img-holder">
                                    <img src="<?php echo get_template_directory_uri()?>/assets/images/about/2.jpg" alt="Awesome Image">
                                </div>
                            </li>
                            <li>
                                <div class="img-holder">
                                    <img src="<?php echo get_template_directory_uri()?>/assets/images/about/3.jpg" alt="Awesome Image">
                                </div>
                            </li>
                        </ul>
                        <div class="text-holder">
    ...
    <section class="fact-counter-area" style="background-image:url(<?php echo get_template_directory_uri()?>/assets/images/resources/fact-counter-bg.jpg);">
        <div class="container">
            <div class="row">
                <!--Start single item-->
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="single-product">
                                    <ul>
                                        <li>
                                            <div class="img-holder">
                                                <img src="<?php echo get_template_directory_uri()?>/assets/images/appoinment/before-1.jpg" alt="Awesome Image">
                                        ...
                                        <li>
                                            <div class="img-holder">
                                                <img src="<?php echo get_template_directory_uri()?>/assets/images/appoinment/after-1.jpg" alt="Awesome Image">
                                                <div class="overlay-box">
                                                    <div class="box">
                                                        <div class="content">
                                                            <a href="#">After</a>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="single-product">
                                    <ul>
                                        <li>
                                            <div class="img-holder">
                                                <img src="<?php echo get_template_directory_uri()?>/assets/images/appoinment/before-2.jpg" alt="Awesome Image">
                                                <div class="overlay-box">
                                                    <div class="box">
                                                        <div class="content">
                                                            <a href="#">Before</a>
                                        ...
                                        <li>
                                            <div class="img-holder">
                                                <img src="<?php echo get_template_directory_uri()?>/assets/images/appoinment/after-2.jpg" alt="Awesome Image">
                                                <div class="overlay-box">
                                                    <div class="box">
                                                        <div class="content">
                                                            <a href="#">After</a>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="single-product">
                                    <ul>
                                        <li>
                                            <div class="img-holder">
                                                <img src="<?php echo get_template_directory_uri()?>/assets/images/appoinment/before-3.jpg" alt="Awesome Image">
                                                <div class="overlay-box">
                                                    <div class="box">
                                                        <div class="content">
                                                            <a href="#">Before</a>
                                        ...
                                        <li>
                                            <div class="img-holder">
                                                <img src="<?php echo get_template_directory_uri()?>/assets/images/appoinment/after-3.jpg" alt="Awesome Image">
                                                <div class="overlay-box">
                                                    <div class="box">
                                                        <div class="content">
                                                            <a href="#">After</a>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="single-product">
                                    <ul>
                                        <li>
                                            <div class="img-holder">
                                                <img src="<?php echo get_template_directory_uri()?>/assets/images/appoinment/before-4.jpg" alt="Awesome Image">
                                                <div class="overlay-box">
                                                    <div class="box">
                                                        <div class="content">
                                                            <a href="#">Before</a>
                                        ...
                                        <li>
                                            <div class="img-holder">
                                                <img src="<?php echo get_template_directory_uri()?>/assets/images/appoinment/after-4.jpg" alt="Awesome Image">
                                                <div class="overlay-box">
                                                    <div class="box">
                                                        <div class="content">
                                                            <a href="#">After</a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-latest-blog">
                        <div class="img-holder">
                            <img src="<?php echo get_template_directory_uri()?>/assets/images/blog/lat-blog-1.jpg" alt="Awesome Image">
                            <div class="overlay-box">
                                <div class="box">
                                    <div class="content">
                ...
                <div class="col-md-4">
                    <div class="single-latest-blog">
                        <div class="img-holder">
                            <img src="<?php echo get_template_directory_uri()?>/assets/images/blog/lat-blog-2.jpg" alt="Awesome Image">
                            <div class="overlay-box">
                                <div class="box">
                                    <div class="content">
                                        <a href="blog-single.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                ...
                <div class="col-md-4">
                    <div class="single-latest-blog">
                        <div class="img-holder">
                            <img src="<?php echo get_template_directory_uri()?>/assets/images/blog/lat-blog-3.jpg" alt="Awesome Image">
                            <div class="overlay-box">
                                <div class="box">
                                    <div class="content">
                                        <a href="blog-single.html"><i class="fa fa-link" aria-hidden="true"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="testimonial-carousel">
                        ...
                        <div class="single-item text-center">
                            <div class="img-holder">
                                <img src="<?php echo get_template_directory_uri()?>/assets/images/testimonial/1.png" alt="Awesome Image">
                            </div>
                            <div class="text-holder">
                        ...
                        <div class="single-item text-center">
                            <div class="img-holder">
                                <img src="<?php echo get_template_directory_uri()?>/assets/images/testimonial/2.png" alt="Awesome Image">
                            </div>
                            <div class="text-holder">
                        ...
                        <div class="single-item text-center">
                            <div class="img-holder">
                                <img src="<?php echo get_template_directory_uri()?>/assets/images/testimonial/3.png" alt="Awesome Image">
                            </div>
                            <div class="text-holder">
                                <h5>Water Damage Repair</h5>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="brand">
                        <!--Start single item-->
                        <div class="single-item">
                            <a href="#"><img src="<?php echo get_template_directory_uri()?>/assets/images/brand/1.jpg" alt="Awesome Brand Image"></a>
                        </div>
                        <!--End single item-->
                        <!--Start single item-->
                        <div class="single-item">
                            <a href="#"><img src="<?php echo get_template_directory_uri()?>/assets/images/brand/2.jpg" alt="Awesome Brand Image"></a>
                        </div>
                        <!--End single item-->
                        <!--Start single item-->
                        <div class="single-item">
                            <a href="#"><img src="<?php echo get_template_directory_uri()?>/assets/images/brand/3.jpg" alt="Awesome Brand Image"></a>
                        </div>
                        <!--End single item-->
                        <!--Start single item-->
                        <div class="single-item">
                            <a href="#"><img src="<?php echo get_template_directory_uri()?>/assets/images/brand/4.jpg" alt="Awesome Brand Image"></a>
                        </div>
                        <!--End single item-->
                        <!--Start single item-->
                        <div class="single-item">
                            <a href="#"><img src="<?php echo get_template_directory_uri()?>/assets/images/brand/5.jpg" alt="Awesome Brand Image"></a>
                        </div>
                        <!--End single item-->
                    </div>
                </div>

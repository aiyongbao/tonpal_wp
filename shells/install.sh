...
Set_Token(){
    ...
    key=`python -c 'import public; print public.GetRandomString(32)'`
    TOKEN=`python -c 'import public; print public.md5("'${key}'")'`
    TOKEN_ENCRYPT=`python -c 'import public; print public.en_crypt("'${TOKEN}'","'${key}'").decode("utf-8")'`
    API_JSON='{

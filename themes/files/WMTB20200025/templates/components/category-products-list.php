<?php
$sideBarMenu = ifEmptyText(get_query_var('sideBarMenu'), 'Sidebar Menu');
...
?>
    ...
    <ul class="side-cate">
        ...
        ?>
                <li>
                    <a href="<?php echo $item['link'] ?>" onclick="javascript: location.href = '<?php echo $item['link'] ?>';" class='more' id="active" aria-expanded="true" title='<?php echo $item['name'] ?>'><?php echo $item['name'] ?></a>
                    <ul class="sub-menu">
            ...
            <?php } else { ?>
                <li>
                    <a href="<?php echo $item['link'] ?>" title="<?php echo $item['name'] ?>"  class='more' id="active" aria-expanded="true">
                        <?php echo $item['name'] ?>
                    </a>
                </li>
        <?php }

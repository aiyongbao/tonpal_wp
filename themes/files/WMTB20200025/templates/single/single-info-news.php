...
<body>
    <div class="container single-info-news">
        <!-- header start -->
        <?php get_header() ?>
        <!--// header end  -->
            ...
            <div class="layout">
                ...
                <section class="main">
                    ...
                    <div class="iframe-box">
                        <iframe src="/rec-product" style="width:100%;height:1150px" frameborder="no" scrolling="no"></iframe>
                    </div>
                    ...
                    <div class='<?php if (empty($res_post) == false) echo 'border_none' ?>'>

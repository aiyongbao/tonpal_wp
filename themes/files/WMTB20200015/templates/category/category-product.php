            ...
            <section class="main">
                <div class="items_list">
                    <div class="page_title">
                        <?php if ($sub_title == '') { ?>
                            <h1 class="h1-title" style="text-transform:uppercase"><?php echo $the_category_name; ?></h1>
                        <?php } else { ?>
                            <div class="h1-title" style="text-transform:uppercase"><?php echo $the_category_name; ?></div><h1 class="sub-title" style="text-transform:uppercase"><?php echo $sub_title; ?></h1>
                        <?php } ?>
                    </div>

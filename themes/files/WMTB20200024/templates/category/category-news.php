                ...
                <section class="main">
                    <?php if ($subName == '') { ?>
                        <header class="main-tit-bar">
                            <h2 class="title" style="text-transform:uppercase"><?php echo $news_title; ?></h2>
                        </header>
                    <?php } else { ?>
                        <header class="main-tit-bar">
                            <h3 class="title" style="text-transform:uppercase"><?php echo $news_title; ?></h3>
                            <h1 style="text-transform:uppercase"><?php $subName; ?></h1>
                        </header>
                    <?php } ?>
                    <div class="blog_list">
                        <?php if (have_posts()) { ?>
                                    ...
                                    <li class="blog-item">
                                        <figure class="item-wrap">
                                            ...
                                            <figcaption class="item-info">
                                                ...
                                                <div class="item-detail limit-3-line" style="margin-bottom:.1rem"><?php the_excerpt(); ?></div>

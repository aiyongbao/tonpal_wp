            ...
            <section class="layout">
                ...
                <section class="main">
                            ...
                            <ul class="gm-sep">
                                ...
                                ?>
                                    <div class="product-item">
                                        ...
                                        <div class="item-wrap">
                                            <div class="pd-img"><a href="<?php echo get_permalink($item->ID); ?>"><img src="<?php echo $thumbnail ?>_thumb_262x262.jpg" alt="<?php echo $item->post_title; ?>" /></a></div>
                                            <div class="pd-info">
                    ...
                    <div class="goods-summary">
                        <p class="class-desc" style="margin-bottom:30px;"><?php echo $products_footer_desc; ?></p><!-- 后台数据 -->
                    </div>
                </section>
                <!--// main end -->
